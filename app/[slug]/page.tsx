...
export default async function PostPage({
  ...
  const editUrl = `https://github.com/sriramprasanth/sriramprasanth.github.io`;
  return (
    <>
      <article>
        <h1
        ...
        <div className="markdown flex flex-col gap-8 mt-12">
                ...
                components={{
                  ...
                  img: async ({ src, ...rest }) => {
                    ...
                    if (src && !/^https?:\/\//.test(src)) {
                      // https://github.com/gaearon/dragon-slayer.io/issues/827
                      finalSrc = `/${slug}/${src}`;
                    }
          ...
          <p>
            ...
            <TextLink href={editUrl}>Fork on GitHub</TextLink>
          </p>
        </div>
      </article>
    </>
